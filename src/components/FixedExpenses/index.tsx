...
import { FixedExpenseFilterSchema, FixedExpenseOutSchema } from "@/types";
...
export default async function FixedExpenseTable({month_id}: { month_id: FixedExpenseOutSchema['month']['id']}) {
